...
class TransformerModel(FairseqEncoderDecoderModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--attn_head_dim', type=int, default=0,
                            help='dim of each attention head, 0 denotes following the default model')

        parser.add_argument('--alpha', type=float, default=1.0,
                            help='# of parallel for attention layer')
        parser.add_argument('--fc_alpha', type=float, default=1.0,
                            help='# of parallel for fc layer')

        parser.add_argument('--head_dropout', type=float, default=0.,
                            help='dropout rate for invidual attention head')
        # fmt: on
...
def base_architecture(args):
    ...
    args.alpha = getattr(args, 'alpha', 1.)
    args.fc_alpha = getattr(args, 'fc_alpha', 1.)
    args.head_dropout = getattr(args, 'head_dropout', 0.)
